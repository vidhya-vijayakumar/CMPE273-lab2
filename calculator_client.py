...
def run():
    ...
    #Addition in client side
       # print("value of B is: " + response.message2) 
        #z = int(response.message)
        #x = int(response.message2)
        #y = x+zs
       # print ("y is:", y)
       # response = stub.SayHelloAgain(helloworld_pb2.HelloRequest(name=input("b3")))
